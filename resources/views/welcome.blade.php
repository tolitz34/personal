    ...
    <div id="tf-clients" class="text-center">
        <div class="overlay">
            <div class="container">
                ...
                <div id="clients" class="owl-carousel owl-theme row">
                    <div class="item">
                        <img src="img/client/01.png">
<!--                         {!! Html::image('img/client/01.png') !!}-->
                        </div>
...
<!--    {{ Html::script('js/jquery.1.11.1.js', array('type' => 'text/javascript')) }}-->
<!--    {{ Html::script('js/bootstrap.js', array('type' => 'text/javascript')) }}-->
<!--    {{ Html::script('js/SmoothScroll.js', array('type' => 'text/javascript')) }}-->
<!--    {{ Html::script('js/jquery.isotope.js', array('type' => 'text/javascript')) }}-->
